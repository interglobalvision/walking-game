...
_this.setLoops(currentLoops+1),_this.nextWorld(),_this.setRank(),console.log("Loops so far",currentLoops),_this.setupLoop()},
// WORLD
...
// RANK
setRank:function(){window.localStorage.setItem("rank",_this.newRank())},newRank:function(){return Utilities.Word.getAdj(!0,!0)+" "+Utilities.Word.getNoun(!1,!0)},getRank:function(){return window.localStorage.getItem("rank")},
// MINI GAME
