...
// WORLD
nextWorld:function(){var _this=this,currentWorld=_this.getWorld(),nextWorld=currentWorld+1;nextWorld+1===_this.worlds.length?window.localStorage.setItem("world",0):window.localStorage.setItem("world",nextWorld)},getWorld:function(){return window.localStorage.getItem("world")},getWorldName:function(){var _this=this,worldNum=_this.getWorld();return _this.worlds[worldNum]},
// RANK
