...
receivedEvent:function(id){console.log("Received Event: "+id),$("#game-username").html(Game.getUsername()),$("#game-points").html(Game.getPoints()),$("#game-gems").html(Game.getGems()),$("#game-progress").html(Game.getProgressPercent())}};app.initialize(),Utilities={},Menu={$blackout:$("#blackout"),$menu:$(".menu"),$menuButton:$("#map-menu-button"),$menuPoints:$("#menu-points"),$menuDistance:$("#menu-distance"),$menuRank:$("#menu-rank"),$menuWorld:$("#menu-world"),$buttonShare:$('[data-ref="menu-share"]'),$buttonSub:$(".toggle-sub"),$buttonBack:$(".menu-back"),howtoGreeting:"<p>dear "+Game.getUsername()+",</p>",
// Dev controls
