...
_this.setLoops(currentLoops+1),_this.setWorld(currentWorld+1),console.log("Loops so far",currentLoops),_this.setupLoop()},
// WORLD
setWorld:function(world){var _this=this;world+1===_this.worlds.length?window.localStorage.setItem("world",0):window.localStorage.setItem("world",world)},getWorld:function(){return window.localStorage.getItem("world")},getWorldName:function(){var _this=this,worldNum=_this.getWorld();return _this.worlds[worldNum]},
// RANK
setRank:function(){},getRank:function(){},
// MINI GAME
