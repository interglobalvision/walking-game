...
// Reset destiny
_this.$resetDestiny.on("click",function(event){event.preventDefault(),_this.toggleMenu(),Utilities.Dialog.read(_this.resetDestinyDialog,function(){Compass.resetDestiny()})}),
