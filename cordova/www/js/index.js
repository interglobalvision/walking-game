...
// most likely usecase
unsupported:function(tech){var _this=this;tech||(tech="the required technology"),console.log(tech+" is unsupported on this device"),alert("Sorry your device does not support "+tech+" :( But you have unclaimed misssold PPI. Collect "+_this.unsupportedCompensation+" points and pass go."),Game.gameComplete(_this.unsupportedCompensation)},
// perhaps this is only likely to happen if a user says no to GPS
unsupportedGPS:function(){console.log("Fuck. No GPS"),alert("Sorry but your device does not support the required GPS or you have denied the app access to your location. You can't go walking if the Coach doesn't know where you are")}},Game={minigames:["tippyswitch","math","supertap","reset","colorsnap","vibeystopper","jankenpon","wordltraveler"],worlds:["Desert","City","Arctic","Jungle"],gameAttempts:2,shareTitle:function(score){return"WOOAAAAHH! U HAVE AN AWESOME SCORe 0F "+score+" POIIINTSSS BRAAAHHH"},shareSubject:"Subject: I did this on Walking Game. The most tiring phone game ever made",shareUrl:"http://interglobal.vision/",
// USER
